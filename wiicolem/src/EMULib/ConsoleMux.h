...
#define ShadowPrintXY   ShadowPrintXY_8
...
#define ShadowPrintXY   ShadowPrintXY_16
...
#define ShadowPrintXY   ShadowPrintXY_32
...
void ShadowPrintXY(Image *Img,const char *S,int X,int Y,pixel FG,int BG)
{
  switch(Img->D)
  {
    case 8:  ShadowPrintXY_8(Img,S,X,Y,FG,BG);break;
    case 16: ShadowPrintXY_16(Img,S,X,Y,FG,BG);break;
    case 24:
    case 32: ShadowPrintXY_32(Img,S,X,Y,FG,BG);break;
  }
}
